...
<img class="ui fluid right floated medium image" src="{{ site.baseurl }}/images/alerts_manager.png">
...
## VIP Poster Session
<img class="ui right floated medium image" src="{{ site.baseurl }}/images/vip-poster.jpg">
